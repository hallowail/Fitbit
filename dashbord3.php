...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <button class="button" onclick="toggleDetails()">Toon meer</button>
        </div>

        <!-- Uitgebreide gegevens -->
        <div id="details" class="card hidden">
            <h2>Uitgebreide gegevens</h2>
            <p><strong>Details over activiteit:</strong></p>
            <canvas id="activityChart"></canvas>

            <p><strong>Details over hartslag:</strong></p>
            <canvas id="heartRateChart"></canvas>

            <p><strong>Details over slaapkwaliteit:</strong></p>
            <canvas id="sleepChart"></canvas>

            <button class="button" onclick="toggleDetails()">Toon minder</button>
        </div>
    </div>
    ...
    <script>
        ...
        // Voeg vergelijkbare code toe voor hartslag- en slaapgrafieken
    </script>
</body>
</html>
