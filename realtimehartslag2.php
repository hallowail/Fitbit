...
if ($httpCode === 200) {
    ...
    // Helperfunctie om veilige waarden te krijgen
    function safeValue($array, $key, $default = 'Niet beschikbaar') {
...
<body>
    ...
    <table>
        ...
        <tr>
            <td>Lengte</td>
            <td>" . safeValue($user, 'height') . " cm</td>
        </tr>
        <tr>
            <td>Gewicht</td>
            <td>" . safeValue($user, 'weight') . " kg</td>
        </tr>
        <tr>
            <td>Land</td>
            <td>" . safeValue($user, 'country') . "</td>
        </tr>
    </table>
</body>
</html>";
